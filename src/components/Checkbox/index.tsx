...
import { InputPropsTypes, BooleanChangeFnType, WeakenType } from '../../commons/interfaces'
...
export interface CheckBoxArguments
  extends InputPropsTypes,
    WeakenType<React.InputHTMLAttributes<HTMLInputElement>, 'onChange'> {
