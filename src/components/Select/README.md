...
const handleFilterInput = value => console.log(value)
...
<FlexView column>
  ...
  <FlexView hAlign="around">
    ...
    <Select className="w5" label="Choose your small number" filterable filterableProp="value">
    ...
    <Select className="w5" label="Choose your red" filterable filterableProp="value" onFilterInput={handleFilterInput}>
      <div value="Red" className="pa2">Red</div>
      <div value="Amaranth" className="pa2">Amaranth</div>
      <div value="Magenta" className="pa2">Magenta</div>
      <div value="Green" className="pa2">Green</div>
    </Select>
