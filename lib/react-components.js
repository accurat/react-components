...
/* WEBPACK VAR INJECTION */(function(global, module) {var __WEBPACK_AMD_DEFINE_RESULT__;__webpack_require__(15);__webpack_require__(18);__webpack_require__(106);__webpack_require__(110);__webpack_require__(111);__webpack_require__(25);__webpack_require__(62);__webpack_require__(117);__webpack_require__(119);__webpack_require__(120);__webpack_require__(122);__webpack_require__(56);__webpack_require__(123);function _typeof(obj){if(typeof Symbol==="function"&&typeof Symbol.iterator==="symbol"){_typeof=function _typeof(obj){return typeof obj;};}else{_typeof=function _typeof(obj){return obj&&typeof Symbol==="function"&&obj.constructor===Symbol&&obj!==Symbol.prototype?"symbol":typeof obj;};}return _typeof(obj);}/**
 * @license
...
if( true&&_typeof(__webpack_require__(24))=='object'&&__webpack_require__(24)){// Expose Lodash on the global object to prevent errors when Lodash is
...
root._=_;}}).call(this);
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(54), __webpack_require__(105)(module)))
...
module.exports = {
  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
    function (test, buggy, set) {
      try {
        set = __webpack_require__(29)(Function.call, __webpack_require__(51).f(Object.prototype, '__proto__').set, 2);
        set(test, []);
...
__webpack_require__(15);__webpack_require__(18);function _typeof(obj){if(typeof Symbol==="function"&&typeof Symbol.iterator==="symbol"){_typeof=function _typeof(obj){return typeof obj;};}else{_typeof=function _typeof(obj){return obj&&typeof Symbol==="function"&&obj.constructor===Symbol&&obj!==Symbol.prototype?"symbol":typeof obj;};}return _typeof(obj);}var g;// This works in non-strict mode
...
var prefix=__webpack_require__(78);var toCamelCase=__webpack_require__(79);var cache={'float':'cssFloat'};var addPxToStyle=__webpack_require__(82);function style(element,property,value){var camel=cache[property];if(typeof camel==='undefined'){camel=detect(property);}// may be false if CSS prop is unsupported
...
"use strict";
Object.defineProperty(exports,"__esModule",{value:true});exports.Scrollbars=undefined;var _Scrollbars=__webpack_require__(72);var _Scrollbars2=_interopRequireDefault(_Scrollbars);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{"default":obj};}exports["default"]=_Scrollbars2["default"];exports.Scrollbars=_Scrollbars2["default"];
...
/* WEBPACK VAR INJECTION */(function(global) {var now=__webpack_require__(76),root=typeof window==='undefined'?global:window,vendors=['moz','webkit'],suffix='AnimationFrame',raf=root['request'+suffix],caf=root['cancel'+suffix]||root['cancelRequest'+suffix];for(var i=0;!raf&&i<vendors.length;i++){raf=root[vendors[i]+'Request'+suffix];caf=root[vendors[i]+'Cancel'+suffix]||root[vendors[i]+'CancelRequest'+suffix];}// Some versions of FF have rAF but not cAF
...
var div=null;var prefixes=['Webkit','Moz','O','ms'];module.exports=function prefixStyle(prop){// re-use a dummy div
...
__webpack_require__(25);var space=__webpack_require__(80);/**
 * Export.
...
__webpack_require__(25);var clean=__webpack_require__(81);/**
 * Export.
...
__webpack_require__(56);__webpack_require__(25);/**
 * Export.
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var emptyFunction=__webpack_require__(85);var invariant=__webpack_require__(86);var ReactPropTypesSecret=__webpack_require__(97);module.exports=function(){function shim(props,propName,componentName,location,propFullName,secret){if(secret===ReactPropTypesSecret){// It is still safe when called from React.
...
"use strict";
Object.defineProperty(exports,"__esModule",{value:true});exports["default"]=isString;function isString(maybe){return typeof maybe==='string';}
...
"use strict";
Object.defineProperty(exports,"__esModule",{value:true});exports["default"]=returnFalse;function returnFalse(){return false;}
...
"use strict";
Object.defineProperty(exports,"__esModule",{value:true});var containerStyleDefault=exports.containerStyleDefault={position:'relative',overflow:'hidden',width:'100%',height:'100%'};// Overrides containerStyleDefault properties
...
$export($export.P + $export.F * (fails(function () {
  ...
  test.sort(null);
  // Old WebKit
}) || !__webpack_require__(121)($sort)), 'Array', {
...
var isObject = __webpack_require__(7);
var setPrototypeOf = __webpack_require__(52).set;
...
function Button(_a) {
    var _b;
    var children = _a.children, _c = _a.disabled, disabled = _c === void 0 ? false : _c, _d = _a.transparent, transparent = _d === void 0 ? false : _d, _e = _a.reset, reset = _e === void 0 ? false : _e, _f = _a.className, className = _f === void 0 ? '' : _f, _g = _a.style, style = _g === void 0 ? {} : _g, _h = _a.onClick, onClick = _h === void 0 ? function () { } : _h, _j = _a.type, type = _j === void 0 ? 'button' : _j, props = __rest(_a, ["children", "disabled", "transparent", "reset", "className", "style", "onClick", "type"]);
    var classes = classnames_default()(className, 'flex justify-center items-center pointer outline-transparent', (_b = {},
        _b[disabledStyle] = disabled,
        _b[transparentStyle] = transparent && !reset,
        _b[defaultStyle] = !transparent && !reset,
        _b));
    return (external_root_React_commonjs2_react_commonjs_react_amd_react_["createElement"]("button", __assign({}, props, { disabled: disabled, className: classes, style: style, onClick: onClick, type: type }), children));
}
...
var Checkbox_disabledStyle = 'o-30 pointer-events-none';
var inactiveStyle = 'o-50';
var defaultInputStyle = 'bw1 b--black';
var CheckSvg = function (_a) {
    var className = _a.className, style = _a.style;
    return (external_root_React_commonjs2_react_commonjs_react_amd_react_["createElement"]("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 21.25 18.58", className: className, style: style },
        external_root_React_commonjs2_react_commonjs_react_amd_react_["createElement"]("polygon", { points: "7.35 18.58 0 11.23 2.83 8.4 7.15 12.72 18.24 0 21.25 2.63 7.35 18.58", fill: "inherit" })));
};
function Checkbox(_a) {
    var _b, _c;
    var children = _a.children, _d = _a.propSvg, propSvg = _d === void 0 ? null : _d, _e = _a.className, className = _e === void 0 ? '' : _e, _f = _a.inputClassName, inputClassName = _f === void 0 ? '' : _f, _g = _a.style, style = _g === void 0 ? {} : _g, _h = _a.disabled, disabled = _h === void 0 ? false : _h, _j = _a.checked, checked = _j === void 0 ? false : _j, _k = _a.onChange, onChange = _k === void 0 ? function () { } : _k, _l = _a.reset, reset = _l === void 0 ? false : _l, props = Checkbox_rest(_a, ["children", "propSvg", "className", "inputClassName", "style", "disabled", "checked", "onChange", "reset"]);
    function handleChange(event) {
        onChange(event.currentTarget.checked);
    }
    var classes = classnames_default()(className, 'flex items-center w-fit pointer', (_b = {},
        _b[Checkbox_disabledStyle] = disabled,
        _b[inactiveStyle] = !checked && !reset,
        _b));
    var inputClasses = classnames_default()(inputClassName, 'absolute absolute--fill center input-reset outline-0 pointer', (_c = {},
        _c[defaultInputStyle] = !reset,
        _c));
    var SvgComponent = propSvg || CheckSvg;
    return (external_root_React_commonjs2_react_commonjs_react_amd_react_["createElement"]("label", { style: style, className: classes },
        external_root_React_commonjs2_react_commonjs_react_amd_react_["createElement"]("div", { className: "relative", style: {
                width: 18,
                minWidth: 18,
                height: 18,
                minHeight: 18,
            } },
            external_root_React_commonjs2_react_commonjs_react_amd_react_["createElement"]("input", Checkbox_assign({}, props, { className: "ba " + inputClasses, type: "checkbox", checked: checked, onChange: handleChange, style: {
                    width: 18,
                    height: 18,
                } })),
            checked && (external_root_React_commonjs2_react_commonjs_react_amd_react_["createElement"](SvgComponent, { className: "absolute absolute--fill center m-auto pointer-events-none " + inputClasses, style: { width: 10, height: 10, fill: 'currentColor' } }))),
...
var FlexView_assign = (undefined && undefined.__assign) || function () {
    FlexView_assign = Object.assign || function(t) {
        for (var s, i = 1, n = arguments.length; i < n; i++) {
            s = arguments[i];
            for (var p in s) if (Object.prototype.hasOwnProperty.call(s, p))
                t[p] = s[p];
    ...
    return FlexView_assign.apply(this, arguments);
};
var FlexView_rest = (undefined && undefined.__rest) || function (s, e) {
    var t = {};
    for (var p in s) if (Object.prototype.hasOwnProperty.call(s, p) && e.indexOf(p) < 0)
        t[p] = s[p];
    if (s != null && typeof Object.getOwnPropertySymbols === "function")
...
function FlexView(_a) {
    var children = _a.children, column = _a.column, vAlign = _a.vAlign, hAlign = _a.hAlign, grow = _a.grow, shrink = _a.shrink, basis = _a.basis, wrap = _a.wrap, _b = _a.className, className = _b === void 0 ? '' : _b, _c = _a.style, style = _c === void 0 ? {} : _c, props = FlexView_rest(_a, ["children", "column", "vAlign", "hAlign", "grow", "shrink", "basis", "wrap", "className", "style"]);
    function getGrow() {
        if (grow === undefined) {
            return 0;
        }
    ...
    function getStyle() {
        return FlexView_assign({}, getFlexStyle(), style);
    }
    function getContentAlignmentClasses() {
        ...
        return classnames_default()(vAlignClassObject, hAlignClassObject);
    }
    function getClasses() {
        var direction = column && 'flex-column';
        var wrapClassName = wrap && 'flex-wrap';
        var contentAlignment = getContentAlignmentClasses();
        return classnames_default()('flex', direction, contentAlignment, wrapClassName, className);
    }
    return (external_root_React_commonjs2_react_commonjs_react_amd_react_["createElement"]("div", FlexView_assign({ className: getClasses(), style: getStyle() }, props), children));
}
...
var Radio_disabledStyle = 'o-30 pointer-events-none';
var Radio_inactiveStyle = 'o-50';
var Radio_defaultInputStyle = 'bw1 b--black bg-black outline-transparent';
function Radio(_a) {
    var _b, _c;
    var children = _a.children, _d = _a.className, className = _d === void 0 ? '' : _d, _e = _a.inputClassName, inputClassName = _e === void 0 ? '' : _e, _f = _a.style, style = _f === void 0 ? {} : _f, _g = _a.disabled, disabled = _g === void 0 ? false : _g, _h = _a.checked, checked = _h === void 0 ? false : _h, _j = _a.onChange, onChange = _j === void 0 ? function () { } : _j, _k = _a.reset, reset = _k === void 0 ? false : _k, props = Radio_rest(_a, ["children", "className", "inputClassName", "style", "disabled", "checked", "onChange", "reset"]);
    function handleChange(event) {
        onChange(event.currentTarget.checked);
    }
    var classes = classnames_default()(className, 'flex items-center w-fit pointer', (_b = {},
        _b[Radio_disabledStyle] = disabled,
        _b[Radio_inactiveStyle] = !checked && !reset,
        _b));
    var inputClasses = classnames_default()(inputClassName, 'absolute absolute--fill center ba', (_c = {},
        _c[Radio_defaultInputStyle] = !reset,
        _c));
    return (external_root_React_commonjs2_react_commonjs_react_amd_react_["createElement"]("label", { className: classes, style: style },
        external_root_React_commonjs2_react_commonjs_react_amd_react_["createElement"]("div", { className: "relative", style: {
                width: 18,
                minWidth: 18,
                height: 18,
            ...
            external_root_React_commonjs2_react_commonjs_react_amd_react_["createElement"]("input", Radio_assign({}, props, { className: inputClasses + " input-reset br-100 pointer", type: "radio", checked: checked, onChange: handleChange, style: {
                    width: 18,
                    height: 18,
            ...
            checked && (external_root_React_commonjs2_react_commonjs_react_amd_react_["createElement"]("div", { className: inputClasses + " z-5 m-auto br-100", style: {
                    width: 10,
                    height: 10,
                } }))),
        children && external_root_React_commonjs2_react_commonjs_react_amd_react_["createElement"]("div", { className: "ml2 pointer" }, children)));
}
...
var Select_disabledStyle = 'o-50 pointer-events-none';
var Select_defaultStyle = 'b--black br1';
var defaultChildrenStyle = 'shadow-4 bg-white';
var DropdownSvg = function (_a) {
    var style = _a.style;
    return (external_root_React_commonjs2_react_commonjs_react_amd_react_["createElement"]("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 8 4", style: style },
        external_root_React_commonjs2_react_commonjs_react_amd_react_["createElement"]("polygon", { points: "0 0 8 0 4 4 0 0", fill: "inherit" })));
};
var Select_Select = /** @class */ (function (_super) {
    ...
    Select.prototype.render = function () {
        ...
        var classes = classnames_default()(className, 'flex justify-between items-center pointer pa2 ba', (_a = {},
            _a[Select_disabledStyle] = disabled,
            _a[Select_defaultStyle] = !reset,
            _a));
        var childrenClasses = classnames_default()(childrenClassName, 'absolute z-5', (_b = {
                dn: !open,
                'w-100': scrollable,
                h5: open && scrollable
            },
            ...
            _b));
        var props = Object(lodash["omit"])(this.props, Object.keys(Select.defaultProps));
        return (external_root_React_commonjs2_react_commonjs_react_amd_react_["createElement"]("div", Select_assign({}, props, { ref: function (el) {
                _this.container = el;
            }, className: "relative" }),
            external_root_React_commonjs2_react_commonjs_react_amd_react_["createElement"]("div", { onClick: this.handleClick, className: classes, style: style },
                external_root_React_commonjs2_react_commonjs_react_amd_react_["createElement"]("span", null, label),
                external_root_React_commonjs2_react_commonjs_react_amd_react_["createElement"]("div", { className: "ml3 " + (open ? 'rotate-180' : '') },
                    external_root_React_commonjs2_react_commonjs_react_amd_react_["createElement"](DropdownSvg, { style: { width: 10, height: 10, fill: 'currentColor' } }))),
            external_root_React_commonjs2_react_commonjs_react_amd_react_["createElement"]("div", { className: childrenClasses }, scrollable ? (external_root_React_commonjs2_react_commonjs_react_amd_react_["createElement"](lib_default.a, { className: "h-100" }, external_root_React_commonjs2_react_commonjs_react_amd_react_["Children"].map(children, function (child, i) {
...
var TextInput_assign = (undefined && undefined.__assign) || function () {
    TextInput_assign = Object.assign || function(t) {
        for (var s, i = 1, n = arguments.length; i < n; i++) {
            s = arguments[i];
            for (var p in s) if (Object.prototype.hasOwnProperty.call(s, p))
                t[p] = s[p];
    ...
    return TextInput_assign.apply(this, arguments);
};
var TextInput_rest = (undefined && undefined.__rest) || function (s, e) {
    var t = {};
    for (var p in s) if (Object.prototype.hasOwnProperty.call(s, p) && e.indexOf(p) < 0)
        t[p] = s[p];
    if (s != null && typeof Object.getOwnPropertySymbols === "function")
...
var TextInput_disabledStyle = 'o-50 pointer-events-none';
var TextInput_defaultStyle = 'b--black black bg-white';
var TextInput_handleChange = function (onChange, checkValidity) { return function (event) {
    onChange(event);
    checkValidity(event.target.checkValidity());
}; };
function TextInput(_a) {
    var _b;
    var value = _a.value, defaultValue = _a.defaultValue, _c = _a.className, className = _c === void 0 ? '' : _c, _d = _a.style, style = _d === void 0 ? {} : _d, _e = _a.type, type = _e === void 0 ? 'text' : _e, _f = _a.onChange, onChange = _f === void 0 ? function () { } : _f, _g = _a.checkValidity, checkValidity = _g === void 0 ? function () { } : _g, _h = _a.reset, reset = _h === void 0 ? false : _h, _j = _a.disabled, disabled = _j === void 0 ? false : _j, props = TextInput_rest(_a, ["value", "defaultValue", "className", "style", "type", "onChange", "checkValidity", "reset", "disabled"]);
    var classes = classnames_default()(className, 'pa2 ba input-reset outline-transparent', (_b = {},
        _b[TextInput_disabledStyle] = disabled,
        _b[TextInput_defaultStyle] = !reset,
        _b));
    return (external_root_React_commonjs2_react_commonjs_react_amd_react_["createElement"]("input", TextInput_assign({}, props, { className: classes, 
        // fontFamily: inherit is an issue with normalize.css,
        // it sets `font-family: sans-serif;` to every input/button
        style: TextInput_assign({}, style, { font: 'inherit' }), type: type, value: value, defaultValue: defaultValue, disabled: disabled, onChange: TextInput_handleChange(onChange, checkValidity) })));
}

// CONCATENATED MODULE: ./src/components/Toggle/index.tsx


var Toggle_disabledStyle = 'o-30 pointer-events-none';
var Toggle_inactiveStyle = 'o-50';
var Toggle_defaultInputStyle = 'br4 bg-black';
function Toggle(_a) {
    var children = _a.children, _b = _a.className, className = _b === void 0 ? '' : _b, _c = _a.inputClassName, inputClassName = _c === void 0 ? '' : _c, _d = _a.style, style = _d === void 0 ? {} : _d, _e = _a.disabled, disabled = _e === void 0 ? false : _e, _f = _a.checked, checked = _f === void 0 ? false : _f, _g = _a.onChange, onChange = _g === void 0 ? function () { } : _g, _h = _a.reset, reset = _h === void 0 ? false : _h;
    var _j, _k;
    function handleChange(event) {
        onChange(event.currentTarget.checked);
    }
    var classes = classnames_default()(className, 'flex flex-row justify-start items-center w-fit pointer', (_j = {},
        _j[Toggle_disabledStyle] = disabled,
        _j[Toggle_inactiveStyle] = !checked && !reset,
        _j));
    var inputClasses = classnames_default()(inputClassName, 'relative', (_k = {},
        _k[Toggle_defaultInputStyle] = !reset,
        _k));
    return (external_root_React_commonjs2_react_commonjs_react_amd_react_["createElement"]("label", { style: style, className: classes },
        external_root_React_commonjs2_react_commonjs_react_amd_react_["createElement"]("div", { className: inputClasses, style: {
                height: 20,
                width: 38,
            } },
            external_root_React_commonjs2_react_commonjs_react_amd_react_["createElement"]("input", { className: "absolute top-0 left-0 o-0 pointer", type: "checkbox", checked: checked, onChange: handleChange, style: {
                    width: 38,
                    height: 20,
                } }),
            external_root_React_commonjs2_react_commonjs_react_amd_react_["createElement"]("div", { className: "absolute center-vertical bg-white br-100 top-0 bottom-0 pointer-events-none", style: {
                    width: 16,
                    height: 16,
...
// CONCATENATED MODULE: ./src/components/Draggable/index.tsx
...
var Draggable_assign = (undefined && undefined.__assign) || function () {
    Draggable_assign = Object.assign || function(t) {
        for (var s, i = 1, n = arguments.length; i < n; i++) {
            s = arguments[i];
            for (var p in s) if (Object.prototype.hasOwnProperty.call(s, p))
                t[p] = s[p];
    ...
    return Draggable_assign.apply(this, arguments);
};

var Draggable_Draggable = /** @class */ (function (_super) {
    ...
    function Draggable() {
        ...
        _this.state = {
            dragging: false,
            hovered: false,
            variable: _this.props.children || ''
        };
        _this.node = null;
        _this.onDragStart = function (event) {
            var variable = _this.state.variable;
        ...
        _this.onDragExit = function (event) {
            var onDragExit = _this.props.onDragExit;
            event.preventDefault();
            if (onDragExit)
                onDragExit(event);
        ...
        _this.onDrop = function (event) {
            if (!_this.props.isTarget)
                return;
            var dropped = event.dataTransfer.getData('id');
            if (!dropped || dropped === 'undefined')
                return;
            var onDrop = _this.props.onDrop;
            onDrop(event);
            _this.setState({ hovered: false, variable: dropped });
        };
        return _this;
    }
    Draggable.prototype.render = function () {
        var _this = this;
        var _a = this.state, dragging = _a.dragging, hovered = _a.hovered, variable = _a.variable;
        var _b = this.props, className = _b.className, isTarget = _b.isTarget, _c = _b.draggingOpacity, draggingOpacity = _c === void 0 ? 0.1775 : _c, _d = _b.style, style = _d === void 0 ? {} : _d, _e = _b.hoverColor, hoverColor = _e === void 0 ? '#d4d4cf' : _e;
        var variableVerbose = this.props.variableVerbose || variable;
        var cursor = dragging ? 'grabbing' : 'grab';
        var opacity = dragging ? draggingOpacity : 1;
        var backgroundColor = hovered ? hoverColor : 'white';
        return (external_root_React_commonjs2_react_commonjs_react_amd_react_["createElement"]("div", { className: "ba pt2 pb2 pl3 pr3 truncate br4 " + className, draggable: true, onDragLeave: this.onDragExit, onDragOver: this.onDragOver, onDragStart: this.onDragStart, onDragEnd: this.onDragEnd, onDragEnter: this.onDragEnter, onDrop: isTarget ? this.onDrop : function () { return _this.setState({ hovered: false }); }, style: Draggable_assign({ opacity: opacity,
                cursor: cursor,
                backgroundColor: backgroundColor }, style), ref: function (el) { _this.node = el; } }, variableVerbose));
    };
    return Draggable;
}(external_root_React_commonjs2_react_commonjs_react_amd_react_["Component"]));
/* harmony default export */ var components_Draggable = (Draggable_Draggable);
...
/* concated harmony reexport Draggable */__webpack_require__.d(__webpack_exports__, "Draggable", function() { return components_Draggable; });
