...
function Checkbox_objectWithoutProperties(source,excluded){if(source==null)return{};var target=Checkbox_objectWithoutPropertiesLoose(source,excluded);var key,i;if(Object.getOwnPropertySymbols){var sourceSymbolKeys=Object.getOwnPropertySymbols(source);for(i=0;i<sourceSymbolKeys.length;i++){key=sourceSymbolKeys[i];if(excluded.indexOf(key)>=0)continue;if(!Object.prototype.propertyIsEnumerable.call(source,key))continue;target[key]=source[key];}}return target;}function Checkbox_objectWithoutPropertiesLoose(source,excluded){if(source==null)return{};var target={};var sourceKeys=Object.keys(source);var key,i;for(i=0;i<sourceKeys.length;i++){key=sourceKeys[i];if(excluded.indexOf(key)>=0)continue;target[key]=source[key];}return target;}var Checkbox_CheckSvg=function CheckSvg(_ref){var className=_ref.className,style=_ref.style;return external_root_React_commonjs2_react_commonjs_react_amd_react_["createElement"]("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 21.25 18.58",className:className,style:style},external_root_React_commonjs2_react_commonjs_react_amd_react_["createElement"]("polygon",{points:"7.35 18.58 0 11.23 2.83 8.4 7.15 12.72 18.24 0 21.25 2.63 7.35 18.58",fill:"inherit"}));};function Checkbox(_ref2){var children=_ref2.children,_ref2$customSvg=_ref2.customSvg,customSvg=_ref2$customSvg===void 0?null:_ref2$customSvg,_ref2$className=_ref2.className,className=_ref2$className===void 0?'':_ref2$className,_ref2$inputClassName=_ref2.inputClassName,inputClassName=_ref2$inputClassName===void 0?'':_ref2$inputClassName,_ref2$style=_ref2.style,style=_ref2$style===void 0?{}:_ref2$style,_ref2$checked=_ref2.checked,checked=_ref2$checked===void 0?false:_ref2$checked,_ref2$onChange=_ref2.onChange,onChange=_ref2$onChange===void 0?function(){}:_ref2$onChange,props=Checkbox_objectWithoutProperties(_ref2,["children","customSvg","className","inputClassName","style","checked","onChange"]);function handleChange(event){onChange(event.currentTarget.checked);}var classes=classnames_default()(className,'flex items-center w-fit',{'o-40 pointer-events-none':props.disabled});var inputClasses=classnames_default()(inputClassName,'absolute absolute--fill center input-reset outline-transparent');var SvgComponent=customSvg||Checkbox_CheckSvg;return external_root_React_commonjs2_react_commonjs_react_amd_react_["createElement"]("label",{style:style,className:classes},external_root_React_commonjs2_react_commonjs_react_amd_react_["createElement"]("div",{className:"".concat(inputClassName," relative ba"),style:{borderColor:'currentColor',boxSizing:'content-box',minWidth:16,maxWidth:30,minHeight:16,maxHeight:30}},external_root_React_commonjs2_react_commonjs_react_amd_react_["createElement"]("input",Object.assign({},props,{className:inputClasses,type:"checkbox",checked:checked,onChange:handleChange,style:{minWidth:16,maxWidth:30,minHeight:16,maxHeight:30}})),checked&&external_root_React_commonjs2_react_commonjs_react_amd_react_["createElement"](SvgComponent,{className:"absolute absolute--fill center m-auto pointer-events-none ".concat(inputClasses),style:{width:10,height:10,fill:'currentColor'}})),children&&external_root_React_commonjs2_react_commonjs_react_amd_react_["createElement"]("div",{className:"ml2"},children));}
